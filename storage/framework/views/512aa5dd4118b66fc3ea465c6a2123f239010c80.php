  ...
  <!-- ======= Sidebar ======= -->
   ...
   <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo e(asset('admin/users/list')); ?>">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo e(asset('logs')); ?>">
       ...
       <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo e(asset('loginuser')); ?>">
          <i class="bi bi-person"></i>
...
</html><?php /**PATH E:\xampp\htdocs\customerportal\resources\views/admin/layouts/master.blade.php ENDPATH**/ ?>